...
<div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
		...
		<div class="lg:col-span-5">
			<div class="relative overflow-hidden rounded-3xl border border-slate-800 bg-slate-900/90 p-8 shadow-2xl space-y-6">
				<div class="flex items-center gap-3">
					...
					<div>
						<h3 class="text-lg font-bold text-white">Modul Khusus Pesantren</h3>
						<p class="text-xs text-slate-400">Siap Pakai & Mudah Direvisi</p>
					</div>
				</div>
	...
	<div class="my-20 space-y-8">
		<div class="text-center max-w-2xl mx-auto space-y-2">
			...
			<h3 class="text-2xl sm:text-4xl font-extrabold text-white">Fasilitas Utama SIM Pesantren Modern</h3>
		</div>

		<div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
			{#each niche.features as feat}
				<div class="rounded-3xl border border-slate-800 bg-slate-900/60 p-6 space-y-3 hover:border-emerald-500/40 transition-colors">
	...
	<div class="my-16 rounded-3xl border border-slate-800 bg-slate-900/40 p-8 text-center space-y-4">
		<h3 class="text-sm font-bold uppercase tracking-wider text-slate-400">Layanan Niche Lainnya</h3>
