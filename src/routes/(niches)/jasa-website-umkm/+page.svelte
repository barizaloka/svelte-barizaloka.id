...
<div class="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
	...
	<div class="my-12 grid grid-cols-1 items-center gap-12 lg:grid-cols-12">
		<div class="space-y-6 lg:col-span-7">
			...
			>
				<Store class="h-4 w-4" />
				<span>Katalog Bisnis & Landing Page UMKM</span>
			</div>
			...
			<div class="flex flex-col items-center gap-4 pt-4 sm:flex-row">
				<a
					href="https://wa.me/6285188158542?text=Halo%20Barizaloka,%20saya%20tertarik%20pembuatan%20website%20UMKM"
					target="_blank"
				...
				>
					...
					<span>Konsultasi Website UMKM</span>
				</a>
		...
		<div class="lg:col-span-5">
			...
			>
				<h3 class="text-lg font-bold text-slate-900 dark:text-white">Alasan UMKM Butuh Website</h3>
				<ul
	...
	<CtaBanner
		title="Tingkatkan Penjualan Usaha Anda Sekarang"
		description="Tampilkan katalog produk profesional dan terima order otomatis via WhatsApp."
		whatsappMessage="Halo Barizaloka, saya tertarik konsultasi website katalog UMKM."
	/>
</div>
